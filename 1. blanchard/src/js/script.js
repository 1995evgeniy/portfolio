...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // const inputError = document.querySelectorAll('.contacts-form__input');
  // const inputErrorLabel = document.querySelectorAll('.js-validate-error-label');

  //   if (inputErrorLabel == true) {
  //     inputError.style.outline = "2px solid $dark-purple";
  //   } else {
